  ...
  Back
    ...
    <div class="flex justify-end gap-3 mb-4 print:hidden">
      <button
        ...
        class="bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-6 py-2 rounded-lg"
      >
    ...
    <div id="printArea" class="mx-auto bg-white text-black">
      ...
      <div class="relative mb-4 font-[Arial] text-[8px]">
        ...
        <div class="text-center leading-tight">
          <div class="font-['Old_English_Text_MT'] text-[12px] font-bold">
            Republic of the Philippines
          </div>

          <div class="font-['Old_English_Text_MT'] text-[18px] font-bold">
            Department of Education
          </div>

          <div class="font-['Times_New_Roman'] text-[12px] font-bold">
      ...
      <div class="form-body border-2 border-black">
        ...
        <div class="border-b border-black p-2 field-row">
          <div class="flex items-baseline flex-wrap" style="column-gap: 2.5rem">
            ...
            <span class="text-[10px]" style="margin-left: 6rem">
              (Middle)
            </span>
          </div>
        ...
        >
          <span>
            ...
            <span class="fill-underline" style="min-width: 95px">
          ...
          <span>
            ...
            <span class="fill-underline" style="min-width: 170px">
          ...
          <span>
            ...
            <span class="fill-underline" style="min-width: 90px">
              {{ leave.employee?.salary ? "₱" + leave.employee.salary : "" }}
            </span>
          </span>
        </div>
          ...
          <div class="px-3 pb-3">
            ...
            <div class="mb-3">
              ...
              <div class="flex items-baseline mt-1">
                <span class="checkbox">
                  <span
                    v-if="leave.vacation_location_type === 'within_philippines'"
                  >
                    &#10003;
                  </span>
                </span>
              ...
              <div class="flex items-baseline mt-1">
                <span class="checkbox">
                  <span v-if="leave.vacation_location_type === 'abroad'">
                    &#10003;
                  </span>
                </span>
            ...
            <div class="mb-3">
              ...
              <div class="flex items-baseline mt-1">
                <span class="checkbox">
                  <span v-if="leave.sick_type === 'in_hospital'">
                    &#10003;
                  </span>
                </span>
              ...
              <div class="flex items-baseline mt-1">
                <span class="checkbox">
                  <span v-if="leave.sick_type === 'out_patient'">
                    &#10003;
                  </span>
                </span>
        ...
        <div class="grid grid-cols-2 border-b border-black">
          ...
          <div>
            ...
            <div class="p-3">
              <div class="flex items-center mb-2">
                <span class="checkbox">
                  <span v-if="leave.recommendation_status === 'approved'">
                    &#10003;
                  </span>
                </span>
              ...
              <div class="flex items-baseline mb-2">
                <span class="checkbox">
                  <span v-if="leave.recommendation_status === 'disapproved'">
                    &#10003;
                  </span>
                </span>
        ...
        <div>
          <div class="grid grid-cols-2">
            ...
            <div class="p-3">
              ...
              <div class="mb-1">
                <span class="fill-underline" style="min-width: 50px">
                  {{ leave.days_with_pay ?? "" }}
                </span>
    ...
    >
      ...
      <div class="attachment-header">
        ...
        <div class="attachment-info">
          <strong> Leave Application ID: </strong>
...
const isLeaveTypeSelected = (lt: { match: string[] }) => {
  ...
  return lt.match.some((match) => name.includes(match));
};
...
const loadLeave = async () => {
  try {
    ...
    console.log("LOADED LEAVE:", leave.value);
    console.log("ATTACHMENTS:", leave.value?.attachments);
...
#printArea {
  ...
  padding: 12.7mm 25.4mm 25.4mm 12.7mm;
...
@media print {
  ...
  #printArea {
    ...
    padding: 12.7mm 25.4mm 25.4mm 12.7mm !important;
