<template>
  <div class="dashboard-shell p-8 min-h-screen">
    <div class="space-y-6">
      ...
      <div class="neo-card p-6">
        <h3 class="text-lg font-semibold text-white mb-4">Select Report Type</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <h4 class="font-medium text-white text-center">{{ reportType.name }}</h4>
      ...
      <div class="neo-card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-2">Quick Select</label>
            <select
        ...
        <div v-if="selectedReportType === 'leave-summary'" class="p-6">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-[#0B1420] border border-slate-800 rounded-lg p-4">
              <h4 class="text-md font-semibold text-white mb-4">Leave by Type</h4>
              <canvas ref="leaveTypeChart"></canvas>
            </div>

            <!-- Leave by Department Chart -->
            <div class="bg-[#0B1420] border border-slate-800 rounded-lg p-4">
              <h4 class="text-md font-semibold text-white mb-4">Leave by Department</h4>
        ...
        <div v-else-if="selectedReportType === 'attendance'" class="p-6">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div class="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
              ...
              <p class="text-3xl font-bold text-white">94.5%</p>
              <p class="text-sm text-green-400 mt-1">↑ 2.3% from last month</p>
            </div>
            ...
            <div class="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
              ...
              <p class="text-sm text-yellow-400 mt-1">↓ 5.1% from last month</p>
            </div>

            <div class="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
              <h4 class="text-md font-semibold text-red-400 mb-2">Absenteeism Rate</h4>
              <p class="text-3xl font-bold text-white">3.2%</p>
          ...
          <div class="bg-[#0B1420] border border-slate-800 rounded-lg p-4 mb-6">
            <h4 class="text-md font-semibold text-white mb-4">Monthly Attendance Trend</h4>
          ...
          <div class="overflow-x-auto">
            <table class="w-full">
              ...
              <tbody class="divide-y divide-slate-800">
                <tr v-for="dept in attendanceData" :key="dept.department" class="hover:bg-white/5 transition">
                  <td class="px-6 py-4 text-sm font-medium text-white">{{ dept.department }}</td>
                  <td class="px-6 py-4 text-sm text-white">{{ dept.totalFaculty }}</td>
                  <td class="px-6 py-4 text-sm text-white">{{ dept.presentDays }}</td>
                  <td class="px-6 py-4 text-sm text-white">{{ dept.lateDays }}</td>
                  <td class="px-6 py-4 text-sm text-white">{{ dept.absentDays }}</td>
...
// Make chart text/gridlines legible on the dark background
...
const getAttendanceRateClass = (rate: number) => {
  ...
  if (rate >= 90) return 'bg-yellow-500/20 text-yellow-400'
